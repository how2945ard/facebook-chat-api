...
function formatThread(data) {
  return {
    ...
    participants: data.participants.map(function(v) { return formatID(v.replace('fbid:', '')); ***REMOVED***,
    participantIDs: data.participants.map(function(v) { return formatID(v.replace('fbid:', '')); ***REMOVED***,
