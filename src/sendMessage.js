...
module.exports = function(defaultFuncs, api, ctx) {
  return function sendMessage(msg, threadID, callback) {
    ...
    if(msgType !== "String" && msgType !== "Object")
      return callback({error: "Message should be of type string or object and not " + threadIDType + "."***REMOVED***;
    if(threadIDType !== "Number" && threadIDType !== "String")
      return callback({error: "ThreadID should be of type number or string and not " + threadIDType + "."***REMOVED***;
