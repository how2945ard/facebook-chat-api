...
module.exports = function(mergeWithDefaults, api, ctx) {
  return function sendMessage(msg, thread_id, callback) {
    ...
    if(msgType !== "String" && msgType !== "Object")
      return callback({error: "Message should be of type string or object and not " + thread_idType + "."***REMOVED***;
    if(thread_idType !== "Number" && thread_idType !== "String")
      return callback({error: "Thread_id should be of type number or string and not " + thread_idType + "."***REMOVED***;
