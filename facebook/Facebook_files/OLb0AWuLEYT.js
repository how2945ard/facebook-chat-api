...
(function(root) {
  ...
  function define(name, deps, factory, prefix, v13, recurring, deepDataAndEvents) {
    ...
    delete old[name];
    fn = new init(name, src, null, factory, deps, v13, prefix, deepDataAndEvents || {***REMOVED***;
    modules[name] = fn;
    main(name);
    return self;
  }
  ...
  var d = root.performance || (root.msPerformance || (root.webkitPerformance || {***REMOVED***);
  if (!d.now) {
...
__d("TimingSeriesStorage", ["TimingSeries"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, Deferred) {
  ...
  var JsDiff = {
    ...
    ***REMOVED***.map(function(dataAndEvents) {
...
__d("DataStore", ["isEmpty"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, callback) {
  ...
  function fn(key) {
    ...
    return items[location] || (items[location] = {***REMOVED***;
  }
  var items = {};
  /** @type {number} */
  var i = 1;
...
***REMOVED***;
  ...
  extend(that, {
    ...
    listen : function(element, type, callback, key) {
      ...
      var id = data_user.get(element, camelKey, {***REMOVED***;
