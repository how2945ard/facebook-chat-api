  ...
  ***REMOVED***;
  ...
  oa(rb.prototype, h, {
    ...
    fetchPinnedThreads: function() {
      dc(this, '/mercury/pinned_threads/', {***REMOVED***;
    },
  ...
  t(aa.prototype, {
    getUnreadCount: function(na) {
      if (this.exceedsMaxCount(na)) {
        z.error('unguarded_unread_count_fetch', {***REMOVED***;
        return 0;
      }
      return ea(this, na);
    },
  ...
  ***REMOVED***;
    (oa.message_counts || []).forEach(function(qa) {
      ...
      if (qa.unread_count > y) {
        ...
        if (na._initialUnreadCount[pa] === 0) ba(na, pa, {***REMOVED***;
        na._threadInformer.updatedUnreadState();
      }
  ***REMOVED***;
...
__d("MercuryParticipantListRenderer", ["fbt"], function(a, b, c, d, e, f, g) {
  ...
  function k(r) {
    return (g._("{participant1***REMOVED***participant2}", [g.param("participant1", r[0]), g.param("participant2", r[1])]));
  }
  ...
  function m(r) {
    return (g._("{participant1***REMOVED***participant2***REMOVED***participant3}", [g.param("participant1", r[0]), g.param("participant2", r[1]), g.param("participant3", r[2])]));
  }

  function n(r) {
    return (g._("{participant1***REMOVED***participant2} and {participant3}", [g.param("participant1", r[0]), g.param("participant2", r[1]), g.param("participant3", r[2])]));
  }

  function o(r) {
    return (g._("{participant1***REMOVED***participant2***REMOVED***participant3***REMOVED***others_link}", [g.param("participant1", r[0]), g.param("participant2", r[1]), g.param("participant3", r[2]), g.param("others_link", q(r.length - 3))]));
  }

  function p(r) {
    return (g._("{participant1***REMOVED***participant2} and {others_link}", [g.param("participant1", r[0]), g.param("participant2", r[1]), g.param("others_link", q(r.length - 2))]));
  }
  ...
  var m = j.createClass({
    ...
    ***REMOVED***;
    ...
    _renderTitleWithUnreadCount: function(n, o) {
      return (l._("{conversation-title} ({unread-count***REMOVED***", [l.param("conversation-title", n), l.param("unread-count", o)]));
    }
***REMOVED***;
  e.exports = m;
}, null);
