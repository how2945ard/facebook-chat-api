...
__d("ChatSortUsers", ["AvailableListConstants", "OrderedFriendsList", "PresencePrivacy", "PresenceStatus", "ShortProfiles", "TokenizeUtil"], function(a, b, c, d, e, f, g, h, i, j, k, l) {
  ...
  function o(q) {
    if (n[q]) return n[q];
    var r = (k.getNowUnsafe(q) || {***REMOVED***.name;
...
__d("ChatTypeaheadBehavior", ["ChatOpenTab", "CSS", "MercuryConfig", "Parent", "Rect", "copyProperties", "cx"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
  ...
  o.prototype.enable = function() {
    ...
    this._subscriptions = [p.subscribe('focus', function() {
      ...
      n(p.getElement(), true);
  ***REMOVED***, p.subscribe('blur', function(q) {
      if (!i.SidebarClearTypeaheadGK) p.getCore().reset();
      n(p.getElement(), false);
  ***REMOVED***, p.subscribe('respond', function(q, r) {
  ...
  ***REMOVED***, p.subscribe('reset', function() {
      h.removeClass(p.getElement(), 'hasValue');
  ***REMOVED***, p.subscribe('select', function(q, r) {
  ...
  ***REMOVED***, p.subscribe('highlight', function(q, r) {
      if (r.index >= 0) {
...
__d("MercuryMessageError.react", ["CurrentUser", "ImmutableObject", "MercuryErrorInfo", "MercuryMessageActions", "React", "cx", "joinClasses"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
  ...
  var n = k.PropTypes,
    o = k.createClass({
      ...
      ***REMOVED***, k.createElement("div", {
          className: "_2fs1"
      ***REMOVED***, k.createElement("span", {
...
***REMOVED***;
  var q = function() {
    ...
    this.swf = j.embed('/swf/SoundStreamPlayer.swf', w, null, {***REMOVED***;
    this.interval = null;
    ...
    v = n.createClass({
      ...
      componentDidMount: function() {
        ...
        this._subscriptionsHandler.addSubscriptions(this.subscribe('playing', this.updateTime), this.subscribe('played', s(this.setState, this, {
          playing: true,
          started: true
      ***REMOVED***), this.subscribe('paused', s(this.setState, this, {
          playing: false
      ***REMOVED***), this.subscribe('finished', s(this.setState, this, {
          playing: false,
          started: false,
          time: this.props.duration
      ***REMOVED***), g.subscribe(t, function(w, x) {
  ...
  var i = 4,
    ...
    k = g.createClass({
      ...
      render: function() {
        ...
        ***REMOVED***.map(function(o, p) {
            return l - p * i;
        ***REMOVED***.map(function(o) {
  ...
  var p = {
    ...
    ***REMOVED***;
      ...
      if (v.length === 0) {
        ...
        } else w = o._("{participant1***REMOVED***participant2}", [o.param("participant1", v[0]), o.param("participant2", v[1])]);
        ...
        ***REMOVED***)]);
          ...
          w = o._("{participant1***REMOVED***participant2} and {participant3}", [o.param("participant1", v[0]), o.param("participant2", v[1]), o.param("participant3", v[2])]);
        } else w = o._("{participant1***REMOVED***participant2} and {others_link}", [o.param("participant1", v[0]), o.param("participant2", v[1]), o.param("others_link", this.renderRawParticipantCount({
          render_subset: true,
          count: s - 2
      ***REMOVED***)]);
      } else if (v.length == 3) {
        w = o._("{participant1***REMOVED***participant2***REMOVED***participant3}", [o.param("participant1", v[0]), o.param("participant2", v[1]), o.param("participant3", v[2])]);
      } else w = o._("{participant1***REMOVED***participant2***REMOVED***participant3***REMOVED***others_link}", [o.param("participant1", v[0]), o.param("participant2", v[1]), o.param("participant3", v[2]), o.param("others_link", this.renderRawParticipantCount({
        render_subset: true,
        count: s - 3
    ***REMOVED***)]);
    ...
    renderRawTitleWithUnreadCount: function(q, r) {
      var s = q;
      if (r && r > 1) s = i.create('span', {}, o._("{conversation_title} ({unread_count***REMOVED***", [o.param("conversation_title", q), o.param("unread_count", r)]));
      return s;
    },
...
__d("XMessagingForwardAttachmentController", ["XController"], function(a, b, c, d, e, f) {
  e.exports = b("XController").create("\/mercury\/attachments\/forward\/", {***REMOVED***;
}, null);
    ...
    ***REMOVED***;
    ...
    render: function() {
      ...
      return (k.createElement(m, {
        ...
        onClick: this.close
    ***REMOVED***, this.props.disablepaging ? null : k.createElement(v, null), this._renderBottomBar())));
    },
...
__d("MercuryAttachmentVideo.react", ["CenteredContainer.react", "FBOverlayBase.react", "FBOverlayContainer.react", "FBOverlayElement.react", "Image.react", "React", "MessagesViewer", "MessagingVideoViewer.react", "Vector", "cx", "ix"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
  var r = l.createClass({
    ...
    ***REMOVED***)), l.createElement(h, null, l.createElement(k, {
...
__d("MercuryShareLinkUploader", ["ArbiterMixin", "AsyncRequest", "CSS", "DOM", "Event", "Form", "URLScraper", "WebMessengerEvents", "mixin", "isEmpty"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
  ...
  t.prototype.loadShare = function(u) {
    ...
    this.$MercuryShareLinkUploader6 = new h().setMethod('POST').setURI('/ajax/share_scrape.php').setData({
      u: u
  ***REMOVED***.setHandler(this.$MercuryShareLinkUploader9.bind(this).bind(null, u)).setStatusElement(this.$MercuryShareLinkUploader2);
      ...
      ***REMOVED***;
      ...
      logClick: function(ia, ja) {
        new i().setURI('/ajax/chat/video/log_click.php').setData({
          targetUserID: ia,
          clickSource: ja
      ***REMOVED***.setAllowCrossPageTransition(true).setErrorHandler(t).send();
      }
    };
...
__d("XStickerStateInitialDataController", ["XController"], function(a, b, c, d, e, f) {
  e.exports = b("XController").create("\/stickers\/state\/", {***REMOVED***;
}, null);
...
__d("XStickerStateStoreDataController", ["XController"], function(a, b, c, d, e, f) {
  e.exports = b("XController").create("\/stickers\/state\/store\/", {***REMOVED***;
}, null);
...
__d("XStickerSearchNUXSeenController", ["XController"], function(a, b, c, d, e, f) {
  e.exports = b("XController").create("\/stickers\/searchNUX\/seen\/", {***REMOVED***;
}, null);
__d("XStickerTagDataController", ["XController"], function(a, b, c, d, e, f) {
  e.exports = b("XController").create("\/stickers\/tag\/data\/", {***REMOVED***;
}, null);
...
__d("StickerServerRequests", ["AsyncRequest", "Promise", "XStickerPackImagesController", "XStickersAddPackController", "XStickersRemovePackController", "XStickerStateInitialDataController", "XStickerStatePackDataController", "XStickerStateStoreDataController", "XStickerSearchPromotePackController", "XStickerSearchNUXSeenController", "XStickerTagDataController", "XStickerQueryImagesController"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
  ...
  function t(u, v, w) {
    ...
    ***REMOVED***.setAllowCrossPageTransition(w).send();
  ***REMOVED***.then(v);
  }
  e.exports = s;
}, null);
...
__d("MercuryLogMessageRenderer", ["MercuryAttachmentRenderer", "CSS", "DOM", "HovercardLink", "MercuryViewer", "MercuryLogMessageType", "MercuryParticipants", "React", "Image.react", "TextWithEntities.react", "TooltipLink.react", "cx", "fbt", "ix", "OrionMercuryLogMessage"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
  ...
  ***REMOVED***;
  ...
  function aa(qa, ra, sa) {
    ...
    m.getMulti(ta, function(ua) {
      if (qa.author == k.getID()) {
        ra(s._("You added {subscriber1***REMOVED***subscriber2} and {subscriber3}.", [s.param("subscriber1", na(ua[sa[0]])), s.param("subscriber2", na(ua[sa[1]])), s.param("subscriber3", na(ua[sa[2]]))]));
      } else if (sa[0] == k.getID()) {
      ...
      } else ra(s._("{actor} added {subscriber1***REMOVED***subscriber2} and {subscriber3}.", [s.param("actor", na(ua[qa.author])), s.param("subscriber1", na(ua[sa[0]])), s.param("subscriber2", na(ua[sa[1]])), s.param("subscriber3", na(ua[sa[2]]))]));
  ***REMOVED***;
  }
  ...
  function ba(qa, ra, sa) {
    ...
    ***REMOVED***;
      if (qa.author == k.getID()) {
        ra(s._("You added {subscriber1***REMOVED***subscriber2} and {more_people}.", [s.param("subscriber1", na(wa[0])), s.param("subscriber2", na(wa[1])), s.param("more_people", va(wa.slice(2)))]));
      } else if (sa[0] == k.getID()) {
      ...
      } else ra(s._("{actor} added {subscriber1***REMOVED***subscriber2} and {more_people}.", [s.param("actor", na(ua[qa.author])), s.param("subscriber1", na(wa[0])), s.param("subscriber2", na(wa[1])), s.param("more_people", va(wa.slice(2)))]));
  ***REMOVED***;
  }
    ...
    _notifySeenBy: function(y) {
      ...
      m.getMulti(y, function(ba) {
        ...
        if (ha) {
          ...
          fa = u._("Seen by {user1***REMOVED***user2}", [u.param("user1", ba[y[0]].short_name), u.param("user2", ba[y[1]].short_name)]);
        } else if (y.length == 3) {
          fa = u._("Seen by {user1***REMOVED***user2***REMOVED***user3}", [u.param("user1", ba[y[0]].short_name), u.param("user2", ba[y[1]].short_name), u.param("user3", ba[y[2]].short_name)]);
        } else if (y.length > 3) {
          ...
          fa = u._("Seen by {user1***REMOVED***user2***REMOVED***=num more link}", [u.param("user1", ba[y[0]].short_name), u.param("user2", ba[y[1]].short_name), u.param("=num more link", la)]);
          ga = true;
        }
        this._informStateChanged({
          activity: 'seen-by',
    ...
    _notifyTyping: function(y) {
      ...
      m.getMulti(y, function(ba) {
        ...
        if (da > 2 && y.length >= da - 1) {
          ...
          fa = u._("{user1***REMOVED***user2}, and {user3} are typing...", [u.param("user1", ba[y[0]].short_name), u.param("user2", ba[y[1]].short_name), u.param("user3", ba[y[2]].short_name)]);
        } else if (y.length > 3) {
          ...
          fa = u._("{user1***REMOVED***user2}, and {=num more link} are typing...", [u.param("user1", ba[y[0]].short_name), u.param("user2", ba[y[1]].short_name), u.param("=num more link", ja)]);
          ga = true;
        }
        this._informStateChanged({
          activity: 'typing',
  ...
  ***REMOVED***;
  ...
  fa.prototype.initBehaviors = function() {
    ...
    if (this.behaviors instanceof Array) {
      ...
      for (var ga in (this.behaviors || {***REMOVED***) {
    ...
    ja = k.createClass({
      ...
      ***REMOVED***;
      ...
      render: function() {
        ...
        ***REMOVED***, k.createElement("p", null, "No Stickers to Show")));
        }
        return (k.createElement(j, {
...
__d("StickersFlyoutTagSelector.react", ["BanzaiLogger", "Grid.react", "ScrollableArea.react", "Parent", "React", "Image.react", "StickerConfig", "StickerConstants", "StickersFlyoutStickerSelector.react", "StickerInterfaces", "StickerSearch", "StickerState", "StickerUtils", "Toggler", "XUIButton.react", "XUICloseButton.react", "XUITextInput.react", "cx", "emptyFunction", "fbt", "getObjectValues"], function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa) {
  ...
  var ba = h.GridItem,
    ...
    fa = k.createClass({
      ...
      ***REMOVED***;
      ...
      render: function() {
        return (k.createElement("div", {
          ...
          className: "_5jds"
      ***REMOVED***, k.createElement(w, {
          onEnter: this._onEnter,
          onChange: this._inputChanged,
          ref: "inputField",
          placeholder: "Search stickers",
          value: this.state.input
      ***REMOVED***, k.createElement(v, {
          size: "small",
      ...
      ***REMOVED***.sort(function(ha, ia) {
          return ha.order - ia.order;
      ***REMOVED***.map(function(ha, ia) {
          return k.createElement(ba, {
            key: ia
          }, k.createElement("div", {
