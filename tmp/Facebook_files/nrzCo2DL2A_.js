...
__d("ChatSortUsers", ["AvailableListConstants", "OrderedFriendsList", "PresencePrivacy", "PresenceStatus", "ShortProfiles", "TokenizeUtil"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, event, handler, jQuery, $injector, gridStore, contextElem) {
  ...
  function fn(data) {
    ...
    var name = (gridStore.getNowUnsafe(data) || {***REMOVED***.name;
    if (name) {
...
"copyProperties", "createArrayFromMixed", "csx", "cx", "debounce", "emptyFunction", "ge"], function(opt_attributes, matcherFunction, execResult, $sanitize, module, opt_keys, m, key, Color, dataAndEvents, activator, exports, deepDataAndEvents, $templateCache, fn, emu, name, ignoreMethodDoesntExist, List, win, view, set, Event, Company, engine, dom, textAlt, keepData, find, parent, self, ProgressIndicator, Observable, DOM, _, hasOwn, $, positionError, oFunctionBody, subscribe, value, Application) {
  ...
  ***REMOVED***.setAllowCrossPageTransition(true).send();
  }
  /**
   * @return {?}
   */
...
__d("ChatTypeaheadBehavior", ["ChatOpenTab", "CSS", "MercuryConfig", "Parent", "Rect", "copyProperties", "cx"], function(deepDataAndEvents, ignoreMethodDoesntExist, textAlt, keepData, module, opt_attributes, assert, template, dataAndEvents, spec, enable, createObject, matcherFunction) {
  ...
  ***REMOVED***, self.subscribe("blur", function(deepDataAndEvents) {
      if (!dataAndEvents.SidebarClearTypeaheadGK) {
        self.getCore().reset();
      }
      proxy(self.getElement(), false);
  ***REMOVED***, self.subscribe("respond", function(dataAndEvents, test) {
  ...
  ***REMOVED***, self.subscribe("reset", function() {
      template.removeClass(self.getElement(), "hasValue");
  ***REMOVED***, self.subscribe("select", function(dataAndEvents, item) {
  ...
  ***REMOVED***, self.subscribe("highlight", function(dataAndEvents, pos) {
      if (pos.index >= 0) {
...
__d("MercuryMessageError.react", ["CurrentUser", "ImmutableObject", "MercuryErrorInfo", "MercuryMessageActions", "React", "cx", "joinClasses"], function(deepDataAndEvents, ignoreMethodDoesntExist, textAlt, keepData, module, opt_attributes, a, value, record, dataAndEvents, dojo, matcherFunction, update) {
  ...
  var JsDiff = dojo.createClass({
    ...
    ***REMOVED***, dojo.createElement("div", {
        className : "_2fs1"
    ***REMOVED***, dojo.createElement("span", {
...
***REMOVED***;
  ...
  var render = function() {
    ...
    this.swf = adapter.embed("/swf/SoundStreamPlayer.swf", title, null, {***REMOVED***;
    /** @type {null} */
    this.interval = null;
  ...
  var JsDiff = dh.createClass({
    ...
    componentDidMount : function() {
      ...
      this._subscriptionsHandler.addSubscriptions(this.subscribe("playing", this.updateTime), this.subscribe("played", setState(this.setState, this, {
        playing : true,
        started : true
    ***REMOVED***), this.subscribe("paused", setState(this.setState, this, {
        playing : false
    ***REMOVED***), this.subscribe("finished", setState(this.setState, this, {
        playing : false,
        started : false,
        time : this.props.duration
    ***REMOVED***), m.subscribe(msg, function(dataAndEvents, src) {
...
__d("Stars.react", ["React", "cx"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, self, opt_attributes) {
  ...
  var JsDiff = self.createClass({
    ...
    ***REMOVED***.map(function(dataAndEvents, i) {
        return bufLen - i * percentComplete;
    ***REMOVED***.map(function(offsetY) {
  ...
  var JsDiff = {
    ...
    ***REMOVED***;
        ...
        if (args.length == 1) {
          ...
          if (args.length == 2) {
            if (obj.last_separator_uses_and) {
              ...
              a = self._("{participant1***REMOVED***participant2}", [self.param("participant1", args[0]), self.param("participant2", args[1])]);
            }
          } else {
            if (obj.last_separator_uses_and) {
              if (obj.abbr_mode) {
              ...
              ***REMOVED***)]);
                ...
                if (args.length == 3) {
                  a = self._("{participant1***REMOVED***participant2} and {participant3}", [self.param("participant1", args[0]), self.param("participant2", args[1]), self.param("participant3", args[2])]);
                } else {
                  a = self._("{participant1***REMOVED***participant2} and {others_link}", [self.param("participant1", args[0]), self.param("participant2", args[1]), self.param("others_link", this.renderRawParticipantCount({
                    render_subset : true,
                    count : i - 2
                ***REMOVED***)]);
                }
              ...
              if (args.length == 3) {
                a = self._("{participant1***REMOVED***participant2***REMOVED***participant3}", [self.param("participant1", args[0]), self.param("participant2", args[1]), self.param("participant3", args[2])]);
              } else {
                a = self._("{participant1***REMOVED***participant2***REMOVED***participant3***REMOVED***others_link}", [self.param("participant1", args[0]), self.param("participant2", args[1]), self.param("participant3", args[2]), self.param("others_link", this.renderRawParticipantCount({
                  render_subset : true,
                  count : i - 3
              ***REMOVED***)]);
              }
    ...
    renderRawTitleWithUnreadCount : function(value, fn) {
      var wrapper = value;
      if (fn && fn > 1) {
        wrapper = d.create("span", {}, self._("{conversation_title} ({unread_count***REMOVED***", [self.param("conversation_title", value), self.param("unread_count", fn)]));
      }
      return wrapper;
    },
    /**
...
__d("XMessagingForwardAttachmentController", ["XController"], function(dataAndEvents, require, deepDataAndEvents, ignoreMethodDoesntExist, module, textAlt) {
  module.exports = require("XController").create("/mercury/attachments/forward/", {***REMOVED***;
}, null);
...
__d("SpotlightViewerPagers", ["LeftRight.react", "Link.react", "React", "cx"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, type, value, self, opt_attributes) {
  var JsDiff = self.createClass({
    ...
    ***REMOVED***, self.createElement(value, {
    ...
    ***REMOVED***;
    ...
    render : function() {
      ...
      return self.createElement(template, {
        ...
        onClick : this.close
    ***REMOVED***, this.props.disablepaging ? null : self.createElement(attribute, null), this._renderBottomBar()));
    },
    /**
     * @return {?}
     */
  ...
  var JsDiff = dom.createClass({
    ...
    ***REMOVED***;
      ...
      return dom.createElement(n, {
        ...
        onClick : this.close
    ***REMOVED***, dom.createElement(attribute, {
        className : "stat_elem"
...
__d("MercuryAttachmentVideo.react", ["CenteredContainer.react", "FBOverlayBase.react", "FBOverlayContainer.react", "FBOverlayElement.react", "Image.react", "React", "MessagesViewer", "MessagingVideoViewer.react", "Vector", "cx", "ix"], function(dataAndEvents, deepDataAndEvents, ignoreMethodDoesntExist, textAlt, module, keepData, type, t, attribute, value, label, self, res, name, Canvas, opt_attributes, done) {
  var JsDiff = self.createClass({
    ...
    ***REMOVED***)), self.createElement(t, null, self.createElement(label, {
...
__d("MercuryShareLinkUploader", ["ArbiterMixin", "AsyncRequest", "CSS", "DOM", "Event", "Form", "URLScraper", "WebMessengerEvents", "mixin", "isEmpty"], function(ignoreMethodDoesntExist, textAlt, keepData, opt_attributes, module, matcherFunction, _super, dataAndEvents, loading, cell, event, list, Audio, deepDataAndEvents, method, behavior) {
  ...
  init.prototype.loadShare = function(url) {
    ...
    this.$MercuryShareLinkUploader6 = (new dataAndEvents).setMethod("POST").setURI("/ajax/share_scrape.php").setData({
      u : url
  ***REMOVED***.setHandler(this.$MercuryShareLinkUploader9.bind(this).bind(null, url)).setStatusElement(this.$MercuryShareLinkUploader2);
...
Event, left, Command, CLASS, assert, util, todo, api, Rect, defer, browser, dataAndEvents, Client, statusCode, oboeBus, otherMap, f) {
  ...
  var self = {
    ...
    ***REMOVED***.setAllowCrossPageTransition(true).setErrorHandler(statusCode).send();
    }
  };
    ...
    render : function() {
      ...
      if (self.media && self.media.image) {
        return this.renderLink(dom.createElement(type, {
          ...
          width : 68
      ***REMOVED***, html, this.props.children));
      }
...
__d("XStickerStateInitialDataController", ["XController"], function(dataAndEvents, require, deepDataAndEvents, ignoreMethodDoesntExist, module, textAlt) {
  module.exports = require("XController").create("/stickers/state/", {***REMOVED***;
}, null);
...
__d("XStickerStateStoreDataController", ["XController"], function(dataAndEvents, require, deepDataAndEvents, ignoreMethodDoesntExist, module, textAlt) {
  module.exports = require("XController").create("/stickers/state/store/", {***REMOVED***;
}, null);
...
__d("XStickerSearchNUXSeenController", ["XController"], function(dataAndEvents, require, deepDataAndEvents, ignoreMethodDoesntExist, module, textAlt) {
  module.exports = require("XController").create("/stickers/searchNUX/seen/", {***REMOVED***;
}, null);
__d("XStickerTagDataController", ["XController"], function(dataAndEvents, require, deepDataAndEvents, ignoreMethodDoesntExist, module, textAlt) {
  module.exports = require("XController").create("/stickers/tag/data/", {***REMOVED***;
}, null);
...
ignoreMethodDoesntExist, deepDataAndEvents, textAlt, keepData, opt_attributes, matcherFunction, execResult, opt_keys, positionError) {
  ...
  function tick(dt, callback, deepDataAndEvents) {
    ...
    ***REMOVED***.setAllowCrossPageTransition(deepDataAndEvents).send();
  ...
  ***REMOVED***;
  ...
  function initialize(b, callback, path) {
    ...
    deck.getMulti(resolved, function(context) {
      if (b.author == a.getID()) {
        callback(item._("You added {subscriber1***REMOVED***subscriber2} and {subscriber3}.", [item.param("subscriber1", fn(context[path[0]])), item.param("subscriber2", fn(context[path[1]])), item.param("subscriber3", fn(context[path[2]]))]));
      } else {
        if (path[0] == a.getID()) {
          ...
          callback(item._("{actor} added {subscriber1***REMOVED***subscriber2} and {subscriber3}.", [item.param("actor", fn(context[b.author])), item.param("subscriber1", fn(context[path[0]])), item.param("subscriber2", fn(context[path[1]])), item.param("subscriber3", fn(context[path[2]]))]));
        }
      }
  ***REMOVED***;
  }
  ...
  function load(b, success, key) {
    ...
    ***REMOVED***;
      if (b.author == a.getID()) {
        success(item._("You added {subscriber1***REMOVED***subscriber2} and {more_people}.", [item.param("subscriber1", fn(elems[0])), item.param("subscriber2", fn(elems[1])), item.param("more_people", init(elems.slice(2)))]));
      } else {
        if (key[0] == a.getID()) {
          ...
          success(item._("{actor} added {subscriber1***REMOVED***subscriber2} and {more_people}.", [item.param("actor", fn(context[b.author])), item.param("subscriber1", fn(elems[0])), item.param("subscriber2", fn(elems[1])), item.param("more_people", init(elems.slice(2)))]));
        }
      }
  ***REMOVED***;
  }
      ...
      req.getMulti(keys, function(docs) {
        ...
        if (ha) {
          ...
          if (keys.length == 1) {
            ...
            if (keys.length == 2) {
              ch = self._("Seen by {user1***REMOVED***user2}", [self.param("user1", docs[keys[0]].short_name), self.param("user2", docs[keys[1]].short_name)]);
            } else {
              if (keys.length == 3) {
                ch = self._("Seen by {user1***REMOVED***user2***REMOVED***user3}", [self.param("user1", docs[keys[0]].short_name), self.param("user2", docs[keys[1]].short_name), self.param("user3", docs[keys[2]].short_name)]);
              } else {
                if (keys.length > 3) {
                  /** @type {number} */
                  ...
                  ch = self._("Seen by {user1***REMOVED***user2***REMOVED***=num more link}", [self.param("user1", docs[keys[0]].short_name), self.param("user2", docs[keys[1]].short_name), self.param("=num more link", ret)]);
                  /** @type {boolean} */
                  tooltip = true;
                }
              }
        ...
        if (length > 2 && keys.length >= length - 1) {
          ...
          if (keys.length == 1) {
            ...
            if (keys.length == 2) {
              ...
              if (keys.length == 3) {
                ch = self._("{user1***REMOVED***user2}, and {user3} are typing...", [self.param("user1", docs[keys[0]].short_name), self.param("user2", docs[keys[1]].short_name), self.param("user3", docs[keys[2]].short_name)]);
              } else {
                if (keys.length > 3) {
                  /** @type {number} */
                  ...
                  ch = self._("{user1***REMOVED***user2}, and {=num more link} are typing...", [self.param("user1", docs[keys[0]].short_name), self.param("user2", docs[keys[1]].short_name), self.param("=num more link", fn)]);
                  /** @type {boolean} */
                  tooltip = true;
                }
              }
...
"throttle"], function(opt_attributes, matcherFunction, execResult, opt_keys, module, positionError, a, m, result, logger, $templateCache, name, value, ignoreMethodDoesntExist, loading, deepDataAndEvents, self, template, err, Observable, b, event, renderer, $injector, textAlt, dataAndEvents, keepData, domStyle, MapEditor, bowser, $sanitize, expect, topic, getTime) {
  ...
  ***REMOVED***, this.lastMessageIndicatorNode);
  ...
  ***REMOVED***;
  ...
  self.prototype.initBehaviors = function() {
    ...
    if (this.behaviors instanceof Array) {
      ...
      var name;
      for (name in this.behaviors || {***REMOVED*** {
    ...
    ***REMOVED***;
    ...
    render : function() {
      ...
      ***REMOVED***);
        ...
        ***REMOVED***, self.createElement("p", null, "No Stickers to Show"));
        }
      }
      return self.createElement(attribute, {
